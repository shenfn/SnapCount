...
字段格式要求：
- domain_key：仅当 record_type 为 sport/sleep/reading/food 时填写对应 key；财务记录返回 null
...
type RecordType = "expense" | "income" | "sport" | "sleep" | "reading" | "food" | "uncertain";
type BuiltinDomainKey = "sport" | "sleep" | "reading" | "food";
...
function isBuiltinDomain(recordType: string | undefined | null): recordType is BuiltinDomainKey {
  return recordType === "sport" || recordType === "sleep" || recordType === "reading" || recordType === "food";
}
